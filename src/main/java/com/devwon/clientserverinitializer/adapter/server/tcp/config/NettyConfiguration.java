package com.devwon.clientserverinitializer.adapter.server.tcp.config;

import com.devwon.clientserverinitializer.adapter.server.tcp.socket.NettyChannelInitializer;
...
public class NettyConfiguration {
    ...
    public ServerBootstrap serverBootstrap(NettyChannelInitializer nettyChannelInitializer) {
        // ServerBootstrap: 서버 생성을 도와주는 class
